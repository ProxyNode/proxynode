...
#   c) node1 mines 32 blocks, so now node 0 has 500000PRX, node 1 has 4250PRX, node2 has none.
#   d) node0 sends 601 PRX to node2, in two transactions (301 PRX, then 300 PRX).
