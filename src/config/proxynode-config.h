/* src/config/prx-config.h.  Generated from prx-config.h.in by configure.  */
/* src/config/prx-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://proxynode.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Proxynode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Proxynode Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "prx"
