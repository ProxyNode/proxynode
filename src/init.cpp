...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, tor, mempool, net, proxy, Proxynode, (swifttx, masternode, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all Proxynode specific functionality (Masternodes, SwiftTX, Budgeting) (0-1, default: %u)"), 0));
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           FormatParagraph(_(" ")) + "\n" +
           "\n" +
		   FormatParagraph(_("Spearheaded by SizzlePhizzle with support from Maurice, Huitemae, Cookie, SBurns1369, RuLzU, Specthree, SpektralFeniks, SaigonMike, r2, Rig4p and Thommyd. Proxynode has risen from the ashes and is reborn with wallet improvements. Our gratitude goes to the legendary wallet developer Remapper - <https://github.com/Remapper>")) + "\n" +
           "\n" +
