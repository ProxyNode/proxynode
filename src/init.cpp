...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 12195, 39795));
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, mempool, net, prx, (privatesend, swifttx, masternode, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all Prx specific functionality (Masternodes, PrivateSend, SwiftTX, Budgeting) (0-1, default: %u)"), 0));
    ...
    strUsage += HelpMessageOpt("-anonymizeprxamount=<n>", strprintf(_("Keep N PRX anonymized (default: %u)"), 0));
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 12196, 39799));
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(_("Copyright (C) 2018 The Prx Core Developers")) + "\n" +
           "\n" +
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizePrxAmount = GetArg("-anonymizeprxamount", 0);
    if (nAnonymizePrxAmount > 999999) nAnonymizePrxAmount = 999999;
    if (nAnonymizePrxAmount < 2) nAnonymizePrxAmount = 2;
    ...
    LogPrintf("Anonymize Prx Amount %d\n", nAnonymizePrxAmount);
    ...
    /* Denominations
       ...
       For example:
       1PRX+1000 == (.1PRX+100)*10
       10PRX+10000 == (1PRX+1000)*10
    */
