...
Intro
-----
prx (PRX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. prx utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run prx-qt.exe.

Proxynode Core is the original prx client and it builds the backbone of the network.
However, it downloads and stores the entire history of prx transactions;
