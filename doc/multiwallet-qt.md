...
In order to support loading of multiple wallets in prx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prx.cpp.
...
Changes to prx.cpp
----------------------
prx.cpp is the entry point into prx-qt, and as such, will require some minor modifications to provide hooks for
