...
In order to support loading of multiple wallets in proxynode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is proxynode.cpp.
...
Changes to proxynode.cpp
----------------------
proxynode.cpp is the entry point into proxynode-qt, and as such, will require some minor modifications to provide hooks for
