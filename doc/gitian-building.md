...
```bash
    ...
    From https://github.com/proxynode/proxynode
...
For example:
```bash
URL=https://github.com/konez2k/prx.git
...
[prx/gitian.sigs](https://github.com/proxynode/proxynode/gitian.sigs/) repository, or if that's not possible to create a pull
request.
