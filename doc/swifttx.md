...
* WebSocket: [https://github.com/Prx-Project/insight-api-prx#web-socket-api](https://github.com/Prx-Project/insight-api-prx#web-socket-api) 
* API: [https://github.com/Prx-Project/insight-api-prx#swifttx-transactions](https://github.com/Prx-Project/insight-api-prx#swifttx-transactions) 
...
By default, the Prx Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Prx Core daemon:
